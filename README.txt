...
This is the readme for ConeStackerJ, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. ConeStackerJ) > Ok.
...
- To run the project find ConeStackerJ.java (which will be in under src/main/java/net/alus) and right click > Run 'ConeStackerJ'
